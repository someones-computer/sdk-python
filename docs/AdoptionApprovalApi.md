...
------------- | ------------- | -------------
[**adoption_approvals_decide**](AdoptionApprovalApi.md#adoption_approvals_decide) | **POST** /api/adoption_approvals | Creates a AdoptionApproval resource.
[**adoption_approvals_get**](AdoptionApprovalApi.md#adoption_approvals_get) | **GET** /api/adoption_approvals/{id} | Retrieves a AdoptionApproval resource.
[**adoption_approvals_list**](AdoptionApprovalApi.md#adoption_approvals_list) | **GET** /api/adoption_approvals | Retrieves the collection of AdoptionApproval resources.
[**adoption_approvals_withdraw**](AdoptionApprovalApi.md#adoption_approvals_withdraw) | **DELETE** /api/adoption_approvals/{id} | Removes the AdoptionApproval resource.


# **adoption_approvals_decide**
> AdoptionApproval adoption_approvals_decide(adoption_approval_adoption_approval_input)
...
# **adoption_approvals_get**
> AdoptionApproval adoption_approvals_get(id)
...
with someones_computer_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a AdoptionApproval resource.
        api_response = api_instance.adoption_approvals_get(id)
        print("The response of AdoptionApprovalApi->adoption_approvals_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AdoptionApprovalApi->adoption_approvals_get: %s\n" % e)
```
...
# **adoption_approvals_list**
> List[AdoptionApproval] adoption_approvals_list(page=page)
...
with someones_computer_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves the collection of AdoptionApproval resources.
        api_response = api_instance.adoption_approvals_list(page=page)
        print("The response of AdoptionApprovalApi->adoption_approvals_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AdoptionApprovalApi->adoption_approvals_list: %s\n" % e)
```
...
# **adoption_approvals_withdraw**
> adoption_approvals_withdraw(id)
...
with someones_computer_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Removes the AdoptionApproval resource.
        api_instance.adoption_approvals_withdraw(id)
    except Exception as e:
        print("Exception when calling AdoptionApprovalApi->adoption_approvals_withdraw: %s\n" % e)
```
