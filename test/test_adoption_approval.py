...
class TestAdoptionApproval(unittest.TestCase):
    """AdoptionApproval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdoptionApproval:
        """Test AdoptionApproval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdoptionApproval`
        """
        model = AdoptionApproval()
        if include_optional:
