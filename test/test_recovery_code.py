...
class TestRecoveryCode(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecoveryCode:
        """Test RecoveryCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecoveryCode`
        """
        model = RecoveryCode()
        if include_optional:
            return RecoveryCode(
