...
class TestVariableVersion(unittest.TestCase):
    """VariableVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariableVersion:
        """Test VariableVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariableVersion`
        """
