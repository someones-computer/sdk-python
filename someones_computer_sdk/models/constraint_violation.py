...
class ConstraintViolation(BaseModel):
    ...
    """ # noqa: E501
    status: Optional[StrictInt] = 422
    violations: Optional[List[ConstraintViolationViolationsInner]] = None
    detail: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    instance: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["status", "violations", "detail", "type", "title", "instance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "status": obj.get("status") if obj.get("status") is not None else 422,
            "violations": [ConstraintViolationViolationsInner.from_dict(_item) for _item in obj["violations"]] if obj.get("violations") is not None else None,
