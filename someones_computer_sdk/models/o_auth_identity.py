...
class OAuthIdentity(BaseModel):
    ...
    provider_user_id: Optional[StrictStr] = Field(default=None, description="The stable, provider-assigned user id (never the email).", alias="providerUserId")
    user: Optional[User] = None
    id: Optional[StrictStr] = None
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["provider", "providerUserId", "user", "id", "createdAt", "updatedAt"]
...
OAuthIdentity.model_rebuild(raise_errors=False)
