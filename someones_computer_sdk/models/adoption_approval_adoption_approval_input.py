...
class AdoptionApprovalAdoptionApprovalInput(BaseModel):
    """
    ...
    compose_service_name: StrictStr = Field(alias="composeServiceName")
    approved: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["application", "composeServiceName", "approved"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "composeServiceName": obj.get("composeServiceName") if obj.get("composeServiceName") is not None else '',
